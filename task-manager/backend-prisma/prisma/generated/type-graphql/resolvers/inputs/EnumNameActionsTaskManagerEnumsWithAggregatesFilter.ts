...
import { NestedEnumNameActionsTaskManagerEnumsWithAggregatesFilter } from "../inputs/NestedEnumNameActionsTaskManagerEnumsWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { NameActionsTaskManagerEnums } from "../../enums/NameActionsTaskManagerEnums";

@TypeGraphQL.InputType("EnumNameActionsTaskManagerEnumsWithAggregatesFilter", {
  isAbstract: true
})
export class EnumNameActionsTaskManagerEnumsWithAggregatesFilter {
