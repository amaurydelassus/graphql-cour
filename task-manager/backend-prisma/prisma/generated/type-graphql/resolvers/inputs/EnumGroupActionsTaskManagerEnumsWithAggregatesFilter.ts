...
import { NestedEnumGroupActionsTaskManagerEnumsWithAggregatesFilter } from "../inputs/NestedEnumGroupActionsTaskManagerEnumsWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { GroupActionsTaskManagerEnums } from "../../enums/GroupActionsTaskManagerEnums";

@TypeGraphQL.InputType("EnumGroupActionsTaskManagerEnumsWithAggregatesFilter", {
  isAbstract: true
})
export class EnumGroupActionsTaskManagerEnumsWithAggregatesFilter {
