...
export const CREATE_USER_MUTATION = gql`
  mutation SignUp($email: String!, $password: String!, $name: String!, $password_digest: String!) {
    signUp(data: { email: $email, password: $password, name: $name , password_digest: $password_digest}) {
      id
      name
    }
  }
